...
namespace TceAdmin.Util.Validation
{
    public class AssertionConcern
    {
        ...
        public static Boolean AssertArgumentLength(string stringValue, int maximum, string message)
        {
        ...
        public static void AssertArgumentNotEmpty(ICollection obj, string message)
        {
        ...
        protected static void SelfAssertArgumentEquals(object object1, object object2, string message)
        {
            AssertionConcern.AssertArgumentEquals(object1, object2, message);
        }

        protected static void SelfAssertArgumentFalse(bool boolValue, string message)
        {
            AssertionConcern.AssertArgumentFalse(boolValue, message);
        }

        protected static void SelfAssertArgumentLength(string stringValue, int maximum, string message)
        {
            AssertionConcern.AssertArgumentLength(stringValue, maximum, message);
        }

        protected static void SelfAssertArgumentLength(string stringValue, int minimum, int maximum, string message)
        {
            AssertionConcern.AssertArgumentLength(stringValue, minimum, maximum, message);
        }

        protected static void SelfAssertArgumentMatches(string pattern, string stringValue, string message)
        {
            AssertionConcern.AssertArgumentMatches(pattern, stringValue, message);
        }

        protected static void SelfAssertArgumentNotEmpty(string stringValue, string message)
        {
            AssertionConcern.AssertArgumentNotEmpty(stringValue, message);
        }

        protected static void SelfAssertArgumentNotEquals(object object1, object object2, string message)
        {
            AssertionConcern.AssertArgumentNotEquals(object1, object2, message);
        }

        protected static void SelfAssertArgumentNotNull(object object1, string message)
        {
        ...
        protected static void SelfAssertArgumentTrue(bool boolValue, string message)
        {
            AssertionConcern.AssertArgumentTrue(boolValue, message);
        }

        protected static void SelfAssertStateFalse(bool boolValue, string message)
        {
            AssertionConcern.AssertStateFalse(boolValue, message);
        }

        protected static void SelfAssertStateTrue(bool boolValue, string message)
        {
